...
class ShenpeituPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        content = "%s-song-%s-song-%s-song-%s-song-%s-song-%s-song-%s-song-%s-song-%s-song-%s"%(item["text"],item["tag"],item["gif_id"],item["big_url"],item["width"],item["height"],item["small_url"],item["mp4_url"],item["has_text"],item["text_guid"])
